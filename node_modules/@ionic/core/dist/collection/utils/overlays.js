...
export const alertController = /*@__PURE__*/ createController('ion-alert', Alert);
export const actionSheetController = /*@__PURE__*/ createController('ion-action-sheet', ActionSheet);
export const loadingController = /*@__PURE__*/ createController('ion-loading', Loading);
export const modalController = /*@__PURE__*/ createController('ion-modal', Modal);
export const pickerController = /*@__PURE__*/ createController('ion-picker', Picker);
export const popoverController = /*@__PURE__*/ createController('ion-popover', Popover);
export const toastController = /*@__PURE__*/ createController('ion-toast', Toast);
...
export const createOverlay = (tagName, opts, customElement) => {
  /* tslint:disable-next-line */
