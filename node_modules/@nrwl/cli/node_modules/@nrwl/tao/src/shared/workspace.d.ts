...
export declare function globForProjectFiles(root: any): string[];
export declare function deduplicateProjectFiles(files: string[], ig?: Ignore): string[];
export declare function buildProjectConfigurationFromPackageJson(path: string, packageJson: {
    name: string;
}, nxJson: NxJsonConfiguration): ProjectConfiguration & {
    name: string;
};
